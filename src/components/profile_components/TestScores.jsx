...
const TestScores = ({save, user}) => {
    const [info, setInfo] = useState({...user});
    const [gmat, setGmat] = useState(user.english_exam_type && user.english_exam_type != '' ? true: false);
    const [gre, setGre] = useState(user.english_exam_type && user.english_exam_type != '' ? true: false);

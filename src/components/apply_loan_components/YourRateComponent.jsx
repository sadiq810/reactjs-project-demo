                        ...
                        <div className="col-lg-6 col-md-8 col-sm-12">
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div className="form-check last2">
                                    <input className="form-check-input" type="radio" name="flexRadioDefault" onClick={() => setState('rate_checking', 'kyaloOnly')} defaultChecked={loan.rate_checking == 'kyaloOnly'}/>
                                    <label className="form-check-label" htmlFor="flexRadioDefault1">
                                        Check my rate with Kyalo Edu Finance only
                                    </label>
                                </div>
                                <div className="form-check last2">
                                    <input className="form-check-input" type="radio" name="flexRadioDefault"  onClick={() => setState('rate_checking', 'kyaloAndLantern')} defaultChecked={loan.rate_checking == 'kyaloAndLantern'}/>
                                    <label className="form-check-label" htmlFor="flexRadioDefault1">

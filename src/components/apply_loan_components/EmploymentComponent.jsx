...
const EmploymentComponent = ({user, history, setTab, loan, setState, tab}) => {
    return (
                ...
                <div className="row program--wrapper">
                    ...
                    <div className="row mt-40">
                        ...
                        <div className="col-lg-6 col-md-8 col-sm-12 emp--status">
                            ...
                            <button className={"btn btn7 col-lg-2 col-md-4 col-sm-12 "+(loan.is_other_income == 'yes' ? 'selected': '')} onClick={() => setState('is_other_income', 'yes')}>
                                <p>Yes</p>
                            </button>
                            <button className={"btn btn7 col-lg-2 col-md-4 col-sm-12 "+(loan.is_other_income == 'no' ? 'selected': '')} onClick={() => setState('is_other_income', 'no')}>
                                <p>No</p>
                            </button>
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12 simple3">
                                ...
                                <input type="address" className="form-control col-lg-4 col-md-6 col-sm-12 address5" value={loan.annual_income} onChange={(e) => setState('annual_income', e.target.value)} placeholder="Annual income....."/>
                                <p className="para">
                            ...
                            <div className={'col-lg-12 col-md-12 col-sm-12 form--btn-wrapper mt-40 simple2'}>
                                <a className={'float-start'} onClick={() => setTab('education') }><i className="icofont-curved-left"></i>Back</a>
                                <button type='button' className={'btn btn-primary  btn-medium btn-large float-end btn--mobile'} onClick={() => setTab('your_rate')}>Next</button>
                            </div>
                        </div>

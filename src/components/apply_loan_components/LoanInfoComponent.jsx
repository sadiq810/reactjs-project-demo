...
const LoanInfoComponent = ({user, history, setTab, loan, types, setState, tab}) => {
                    ...
                    <div className="row mt-40">
                        ...
                        <div className="simple2 col-lg-6 col-md-9 col-sm-12">
                            ...
                            <div className="row loan--type">
                                {
                                    loans_refinancing.map((l, index) => {
                                        return (
                                            <button key={index} className={"btn btn2 btn4--override col-lg-3 col-md-6 col-sm-12 "+(loan.loan_refinancing == l ? 'selected': '')} onClick={() => setState('loan_refinancing', l)}>
                                                {l}
                                                <span>
                                                    <i className="icofont-check-circled soon"></i>
                                                </span>
                            ...
                            <div className={'col-lg-12 col-md-12 col-sm-12 form--btn-wrapper mt-40 simple2 '}>
                                <a className={'float-start'} onClick={() => setTab('types') }><i className="icofont-curved-left"></i>Back</a>
                                <button type='button' className={'btn btn-primary  btn-medium btn-large float-end btn--mobile'} onClick={() => setTab('about_you')}>Next</button>
                            </div>
                        </div>

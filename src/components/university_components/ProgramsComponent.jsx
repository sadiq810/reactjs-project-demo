...
const ProgramsComponent = ({university, history}) => {
                ...
                <form action="#">
                    <div className={"row"}>
                        <div className={"col-lg-8 col-md-6 col-sm-12"}>
                            ...
                            <input type="text" value={title} onChange={e => setTitle(e.target.value)} name={'program_levels'} className={'form-control form-control2 bg-gray'} placeholder={"I don't have this"} />
                        </div>
                        <div className={"col-lg-4 col-md-6 col-sm-12"}>
                            <label className={"form1"}>Sort by</label>
                            <select name="sort" className={'form-control form-control2 bg-gray'} onChange={e => setSort(e.target.value)}>
                    ...
                    <div className={"row"}>
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12 mt-25">
                            <button className={"btn btn-medium btn-primary"} onClick={() => clearFilters()}>Clear Filters</button>
                        </div>
                    </div>
                </form>
            </div>

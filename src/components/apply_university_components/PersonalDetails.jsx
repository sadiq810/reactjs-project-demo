...
const PersonalDetails = ({history, setStep, setState, data}) => {
    const submit = (e) => {
        e.preventDefault();
                ...
                <div className="row mt-25">
                    <div className="row">
                        <div className="mb-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select className="form-select form-select-sm" value={data.permit} onChange={e => setState('permit', e.target.value)}>
                        ...
                        <div className="mb-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select className="form-select form-select-sm"  value={data.education_country} onChange={e => setState('education_country', e.target.value)}>
                                <option selected>Please select</option>
                        ...
                        <div className="mb-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select className="form-select form-select-sm" value={data.education_level} onChange={e => setState('education_level', e.target.value)}>
                                <option selected>Please select</option>
                        ...
                        <div className="mb-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select className="form-select form-select-sm" value={data.grading_scheme} onChange={e => setState('grading_scheme', e.target.value)}>
                                <option selected>Please select</option>
                        ...
                        <div className="mb-3 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <select className="form-select form-select-sm" value={data.english_exam_type} onChange={e => setState('english_exam_type', e.target.value)}>
                                <option selected>Please select</option>

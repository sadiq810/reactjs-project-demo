                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 tabs--wrapper">
                        ...
                        <p className={'mb-0 top--tabs'}>
                            <a href="#" className={tab == 'general' ? 'active--tab': ''} onClick={() => setTab('general')}>General Information</a>
                            <a href="#" className={tab == 'education' ? 'active--tab': ''} onClick={() => setTab('education')}>Education History</a>
                            <a href="#" className={tab == 'test_score' ? 'active--tab': ''} onClick={() => setTab('test_score')}>Test Scores</a>
                            <a href="#" className={tab == 'background_information' ? 'active--tab': ''} onClick={() => setTab('background_information')}>Background Information</a>
                        </p>
                        <div>
